...
_OID_v5 = "https://storage.googleapis.com/openimages/v7/"
...
def _class_label_codes(
    ...
    classes_csv = "oidv7-class-descriptions.csv"
...
def download_dataset(
    ...
    for split_section in ("train", "val", "test"):
...
def _get_annotations_csv(
    ...
    # get the annotations CSV for the section
    url = _OID_v5 + "oidv7-" + split_section + "-annotations-human-imagelabels.csv"
    try:
...
def _group_bounding_boxes(
    ...
    df_images = df_images[df_images["Confidence"] == 1]
